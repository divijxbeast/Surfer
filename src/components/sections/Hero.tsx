...
export function Hero() {
  ...
  return (
    <section className="relative w-full min-h-[85vh] lg:min-h-[92vh] bg-[#ECEAE5] flex flex-col justify-between pt-12 sm:pt-16 pb-12 sm:pb-16 px-6 sm:px-12 md:px-16 overflow-hidden select-none">
      ...
      <div className="relative w-full max-w-[1600px] mx-auto flex items-center justify-center my-auto py-8 sm:py-12">
        ...
        >
          <div className="relative w-[320px] sm:w-[440px] md:w-[540px] lg:w-[640px] h-[65vh] sm:h-[72vh] lg:h-[78vh] max-h-[660px] flex items-center justify-center">
            ...
            <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[70%] h-6 bg-[radial-gradient(ellipse_at_center,rgba(0,0,0,0.35)_0%,rgba(0,0,0,0)_70%)] blur-sm pointer-events-none" />
            ...
            <div className="relative w-full h-full flex items-center justify-center">
              <Image
                ...
                className="object-contain object-bottom drop-shadow-[0_16px_24px_rgba(0,0,0,0.22)]"
              />
            </div>
          </div>
        </motion.div>
