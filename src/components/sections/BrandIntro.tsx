...
export function BrandIntro() {
  return (
    <section
      id="atelier"
      className="relative w-full py-16 sm:py-36 md:py-48 px-4 sm:px-10 md:px-16 bg-[#FCFAF6] border-t border-[#E2DDD5] scroll-mt-10"
    >
      <div className="max-w-[1440px] mx-auto">
        ...
        {/* Content Grid */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 sm:gap-20 items-center pt-10 sm:pt-24">
          ...
          <div className="lg:col-span-7 flex flex-col justify-center">
            <motion.h2
              ...
              className="font-serif text-3xl sm:text-5xl md:text-6xl text-[#0A0A0A] font-normal leading-[1.04] tracking-[-0.015em] mb-6 sm:mb-10"
            >
            ...
            <motion.div
              ...
              className="space-y-4 sm:space-y-8 text-[#242424]"
            >
              ...
              <p className="text-xs sm:text-base text-[#85837D] leading-relaxed max-w-[55ch]">
            ...
            <motion.div
              ...
              className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-8 pt-8 sm:pt-12 mt-8 sm:mt-12 border-t border-[#E2DDD5]"
            >
              <div className="p-4 sm:p-6 bg-[#F7F5F0] border border-[#E2DDD5]">
                <span className="text-[10px] sm:text-[11px] font-sans font-medium tracking-[0.2em] text-[#9E7B5C] uppercase block mb-1.5 sm:mb-2">
                  CUSTOMIZATION
                </span>
                <span className="font-serif text-xl sm:text-2xl text-[#0A0A0A] block mb-1 font-normal">
          ...
          <div className="lg:col-span-5 relative mt-6 lg:mt-0">
            ...
            >
              ...
              />
              <div className="absolute -bottom-4 -left-3 sm:-bottom-6 sm:-left-6 bg-[#0A0A0A] text-[#F7F5F0] px-4 sm:px-6 py-2.5 sm:py-4 text-[10px] sm:text-xs font-mono tracking-[0.2em] uppercase border border-white/10 shadow-2xl">
